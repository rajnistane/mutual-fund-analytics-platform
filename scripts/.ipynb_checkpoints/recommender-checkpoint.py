...
recommender.py
--------------
Fund Recommendation Engine for Bluestock Fintech Mutual Fund Analytics Platform.
Recommends top 3 mutual funds based on investor risk appetite using Sharpe ratio ranking.
...
def recommend_funds(risk_appetite):
    ...
    Returns:
        pd.DataFrame: Top 3 funds ranked by Sharpe ratio
    """
    risk_map = {
        "Low": ["Low"],
